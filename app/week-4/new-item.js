    ...
    return (
        ...
        <div className="flex justify-center items-center gap-3 bg-white p-3 rounded mx-auto w-40 h-15 shadow ">
            ...
            onClick={decrement} className={
                quantity == 1 ? "bg-gray-200 font-bold text-black px-4 py-2 rounded-lg  cursor-not-allowed" :
                "bg-blue-500 font-bold text-black hover:bg-blue-950 active:bg-gray-700 px-4 py-2 rounded-lg "
